package com.wether.app.config;

import com.wether.app.security.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.POST,"/api/history/**").permitAll()
            .antMatchers(HttpMethod.DELETE,"/api/history/**").permitAll()
